...
function App() {
  ...
  const [widthBlue1, setWidthBlue1] = useState({ width: "45px" });
  const [widthBlue2, setWidthBlue2] = useState({ width: "45px" });
  const [widthBlue3, setWidthBlue3] = useState({ width: "45px" });
  const [widthBlue4, setWidthBlue4] = useState({ width: "45px" });

  const [widthRed1, setWidthRed1] = useState({ width: "45px" });
  const [widthRed2, setWidthRed2] = useState({ width: "45px" });
  const [widthRed3, setWidthRed3] = useState({ width: "45px" });
  const [widthRed4, setWidthRed4] = useState({ width: "45px" });

  const [widthGreen1, setWidthGreen1] = useState({ width: "45px" });
  const [widthGreen2, setWidthGreen2] = useState({ width: "45px" });
  const [widthGreen3, setWidthGreen3] = useState({ width: "45px" });
  const [widthGreen4, setWidthGreen4] = useState({ width: "45px" });

  const [widthYellow1, setWidthYellow1] = useState({ width: "45px" });
  const [widthYellow2, setWidthYellow2] = useState({ width: "45px" });
  const [widthYellow3, setWidthYellow3] = useState({ width: "45px" });
  const [widthYellow4, setWidthYellow4] = useState({ width: "45px" });
    ...
    for (let i = 0; i < pos.length; i++) {
      if (pos[i] !== "0") {
        ...
        if (nb > 1) {
          switch (i) {
            case 0:
              setWidthBlue1({ width: "calc(45px / " + nb + ")" });
              break;
            case 1:
              setWidthBlue2({ width: "calc(45px / " + nb + ")" });
              break;
            case 2:
              setWidthBlue3({ width: "calc(45px / " + nb + ")" });
              break;
            case 3:
              setWidthBlue4({ width: "calc(45px / " + nb + ")" });
              break;
            case 4:
              setWidthRed1({ width: "calc(45px / " + nb + ")" });
              break;
            case 5:
              setWidthRed2({ width: "calc(45px / " + nb + ")" });
              break;
            case 6:
              setWidthRed3({ width: "calc(45px / " + nb + ")" });
              break;
            case 7:
              setWidthRed4({ width: "calc(45px / " + nb + ")" });
              break;
            case 8:
              setWidthGreen1({ width: "calc(45px / " + nb + ")" });
              break;
            case 9:
              setWidthGreen2({ width: "calc(45px / " + nb + ")" });
              break;
            case 10:
              setWidthGreen3({ width: "calc(45px / " + nb + ")" });
              break;
            case 11:
              setWidthGreen4({ width: "calc(45px / " + nb + ")" });
              break;
            case 12:
              setWidthYellow1({ width: "calc(45px / " + nb + ")" });
              break;
            case 13:
              setWidthYellow2({ width: "calc(45px / " + nb + ")" });
              break;
            case 14:
              setWidthYellow3({ width: "calc(45px / " + nb + ")" });
              break;
            case 15:
              setWidthYellow4({ width: "calc(45px / " + nb + ")" });
              break;
          }
        } else {
          switch (i) {
            case 0:
              setWidthBlue1({ width: "45px" });
              break;
            case 1:
              setWidthBlue2({ width: "45px" });
              break;
            case 2:
              setWidthBlue3({ width: "45px" });
              break;
            case 3:
              setWidthBlue4({ width: "45px" });
              break;
            case 4:
              setWidthRed1({ width: "45px" });
              break;
            case 5:
              setWidthRed2({ width: "45px" });
              break;
            case 6:
              setWidthRed3({ width: "45px" });
              break;
            case 7:
              setWidthRed4({ width: "45px" });
              break;
            case 8:
              setWidthGreen1({ width: "45px" });
              break;
            case 9:
              setWidthGreen2({ width: "45px" });
              break;
            case 10:
              setWidthGreen3({ width: "45px" });
              break;
            case 11:
              setWidthGreen4({ width: "45px" });
              break;
            case 12:
              setWidthYellow1({ width: "45px" });
              break;
            case 13:
              setWidthYellow2({ width: "45px" });
              break;
            case 14:
              setWidthYellow3({ width: "45px" });
              break;
            case 15:
              setWidthYellow4({ width: "45px" });
              break;
          }
        }
      }else {
  ...
  function play(p) {
    if (p === player && ableToplay) {
      ...
      // Start rolling the dice every 100ms
      const rollInterval = setInterval(() => {
        const nb = generateRandomIntegerInRange(1, 6);
        setSteps(nb); // Show the current roll on the UI
      }, 35);
      ...
      setTimeout(() => {
        ...
        // Get the final dice roll
        const finalNumber = generateRandomIntegerInRange(1, 6);
        setSteps(finalNumber); // Show the final roll on the UI
  
        // Hold the final number for 2 seconds before allowing the next player
        setTimeout(() => {
          allowPlayer(player, finalNumber); // Allow the player to proceed
          setAbleToPlay(true); // Re-enable play
        }, 900); // Hold for 2 seconds
      }, 1500); // Roll for 2 seconds
    }
  }
